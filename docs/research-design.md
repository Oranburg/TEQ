...
- Compare training R-squared to cross-validated R-squared. If the gap exceeds 0.05, the model is overfit and must be regularized further before being reported.
- Report both training and test set performance for all final models.
